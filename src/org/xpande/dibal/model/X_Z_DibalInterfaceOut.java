...
/** Generated Model for Z_DibalInterfaceOut
 *  @author Adempiere (generated) 
 *  @version Release 3.9.0 - $Id$ */
public class X_Z_DibalInterfaceOut extends PO implements I_Z_DibalInterfaceOut, I_Persistent 
{
    ...
    public X_Z_DibalInterfaceOut (Properties ctx, int Z_DibalInterfaceOut_ID, String trxName)
    {
      super (ctx, Z_DibalInterfaceOut_ID, trxName);
      /** if (Z_DibalInterfaceOut_ID == 0)
        {
			setCRUDType (null);
			setIsError (false);
// N
...
// N
			setRecord_ID (0);
			setSeqNo (0);
			setZ_DibalInterfaceOut_ID (0);
        } */
    }

    /** Load Constructor */
    public X_Z_DibalInterfaceOut (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_Z_DibalInterfaceOut[")
	...
	/** Set Z_DibalInterfaceOut ID.
		@param Z_DibalInterfaceOut_ID Z_DibalInterfaceOut ID	  */
	public void setZ_DibalInterfaceOut_ID (int Z_DibalInterfaceOut_ID)
	{
		if (Z_DibalInterfaceOut_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_Z_DibalInterfaceOut_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_Z_DibalInterfaceOut_ID, Integer.valueOf(Z_DibalInterfaceOut_ID));
	}

	/** Get Z_DibalInterfaceOut ID.
		@return Z_DibalInterfaceOut ID	  */
	public int getZ_DibalInterfaceOut_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_Z_DibalInterfaceOut_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
